...
from daedisaggregator_pytorch import DAEDisaggregator
import metrics
...
dae.disaggregate(test_mains, output, test_mains, sample_period=1)   # train
output.close()
...
print("============ F1 Score: {}".format(rpaf[2])) ### sxolio
